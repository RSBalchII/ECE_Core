This document was consolidated into `specs/TROUBLESHOOTING.md` to comply with the project's documentation policy.

The original content has been archived to `archive/docs_removed/docs/forensic_restoration.md`.

Please review `specs/TROUBLESHOOTING.md` for the canonical details on Forensic Restoration & Annotated Cleaning.
